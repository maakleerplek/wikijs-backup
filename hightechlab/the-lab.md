---
title: The HTL Lab
description: House rules, access instructions, machine usage, and garbage disposal
published: true
date: 2026-05-12T14:02:45.586Z
tags: 
editor: markdown
dateCreated: 2026-03-31T20:44:56.816Z
---

![High Tech Lab](https://maakleerplek.be/wp-content/uploads/2022/10/Horizontal-Logo.png =120x)
# The HTL Lab
...
- Most machines: free to use.
- **Laser cutter, Small CNC, Big CNC:** require certification.
- Recommended: attend a LC operation workshop first, then do certification. Or: read the manual and do the certification via the form.
- Must be **16+** to use LC/CNC without a certified person supervising.

## Pricing

| Machine | Rate | Minimum |
|---|---|---|
| Laser cutter | €0.50/min | €5 |
| 3D printer | €0.10/g | €5 |

Pay via **Payconiq** (QR code on the wall). Volunteers: €5 machine credit/month (12-month expiry, track your own balance).

## Garbage

| Type | Where |
|---|---|
| Paper & carton | Box on top of washing machine. When full → outside to white gate |
| Glass | Under TV screen. When full → glass bowls at the Vaart |
...
The lab schedule is on the MS365 shared calendar. You can subscribe to it in Outlook.

## Contact

klaas.kelchtermans@maakleerplek.be