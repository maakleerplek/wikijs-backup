---
title: Wiki Review — Help Wanted
description: Review checklist for volunteers to verify and correct wiki content
published: true
date: 2026-05-12T14:04:50.132Z
tags: hightechlab, review, feedback
editor: markdown
dateCreated: 2026-03-31T22:28:17.798Z
---

# Wiki Review — Help Wanted

> **Please review the pages relevant to your team/machines and flag anything that's wrong, outdated, or missing.** You can edit pages directly (log in first) or reply in the WhatsApp group with corrections.
{.is-warning}

## What happened

We migrated content from SharePoint to the wiki and found several errors and gaps. Some content was generated from SharePoint sources and may not reflect how things actually work today.

**Already fixed:**
- Opening hours for Young Maker Lab (were wrong on multiple pages)
- Stamhoofd webshop links (were broken or pointing to the wrong URL)
...
- [ ] **Safety rules** for your machine
- [ ] **Basic operating procedure** (even a few bullet points)
...
### Stan
- [ ] Is the Bambu Lab H2D actually at HTL?
- [ ] Small CNC z-axis probe — still broken?
- [ ] Is PLA filament really sold at €20/kg?

## How to edit

1. Go to [wiki.maakleerplek.be](https://wiki.maakleerplek.be)
2. Log in (Keycloak SSO or local account)
3. Navigate to the page
4. Click the pencil icon to edit
5. Save when done

Or just reply in WhatsApp with what's wrong and we'll fix it.

---

*Audit date: 1 April 2026*
*Full audit report: available on request from Stan*